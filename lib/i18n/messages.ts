...
export const EN_MESSAGES = {
  ...
  jobCard: {
    ...
    salaryLabel: 'Salary',
    salaryFrom: (amount: string) => `from ${amount}`,
    salaryUpTo: (amount: string) => `up to ${amount}`,
...
export const PT_BR_MESSAGES: typeof EN_MESSAGES = {
  ...
  jobCard: {
    ...
    salaryLabel: 'Salário',
    salaryFrom: (amount: string) => `a partir de ${amount}`,
    salaryUpTo: (amount: string) => `até ${amount}`,
